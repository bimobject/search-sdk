...
let authGetClientCredentials = {
  // This is an ClientCredentials flow "app".
  grant_type: 'client_credentials',
  scope: 'search_api',
  client_id: 'jMaUGEyQH6V91WjHiEHONErFkrV1WU11', //  Create your own on https://developer.bimobject.com.
  client_secret: 'PTIrFzxiItuIogI31DQvMJFmLayKvbjKAlU9HuSeft3rxrWEFIk48xkefXxIuiML',
};

let authGetAuthPKCode = {
  scope: 'search_api search_api_downloadbinary offline_access',
  client_id: 'Twj31xnlFfDT0dRkJ1vYxv7sYFswI3VY', // This is AuthorizationCodeWithProofKey flow "app". Create your own on https://developer.bimobject.com.
...
let refreshAuthPKToken = {
  ...
  refresh_token: '',
  client_id: 'Twj31xnlFfDT0dRkJ1vYxv7sYFswI3VY', // This is AuthorizationCodeWithProofKey flow  "app".
  client_secret: 'uKFCuYx49dLTwcLgNYy3puIRZVxhtPPqhjSIoKFu0v1XEOaxq7hctp4AovegC7NH',
};
